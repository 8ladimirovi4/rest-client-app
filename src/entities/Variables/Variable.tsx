  ...
  return (
    <>
       <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                <th scope="row" className="text-lg min-w-[300px] w-[300px] px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                {!isEdit ? 
                (<p>{variable.key}</p>) 
                : 
                (<Input
                  ...
                  type={'text'}
                  value={variable.key}
                  onChange={(evt) => {updateVariable(id, evt.target.value, variable.value)}}
                 />)}
                </th>
